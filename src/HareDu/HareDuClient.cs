namespace HareDu
{
    ...
    public interface HareDuClient
    {
        ...
        /// <returns></returns>
        Task<HttpResponseMessage> GetListOfAllOpenConnections(CancellationToken cancellationToken =
                                                                                  default(CancellationToken));

        Task<HttpResponseMessage> GetOpenConnection(string connectionName,
